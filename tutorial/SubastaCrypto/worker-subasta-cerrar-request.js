...
const _queue_name = "subasta.cierre.request.queue";
...
async function fnCerrarSubasta(json_request_dto ) {
  ...
  try {
    ...
    fnPublicarMensajeMQ("subasta.cerrar.response.queue", json_response);
